...
enum FieldDemoData {
    ...
    static func date(
        ...
        let base = Calendar.gregorianUS.date(
            from: DateComponents(
                year: year,
                month: month,
                day: day,
    ...
    static let clusters: [FieldCluster] = [
        ...
        FieldCluster(
            id: "wedding",
            title: "Wedding week",
            rationale: "User 2's birthday and Marissa's wedding are five days "
    ...
    static let lifeItems: [LifeItem] = [
        ...
        LifeItem(
            ...
            clusterID: "dad",
            source: .inferred,
            detail: "out, or at User 2's — both of you",
        ...
        LifeItem(
            id: "birthday",
            title: "User 2's birthday — Sunday",
            category: .care,
            owner: .a,
        ...
        LifeItem(
            id: "cake",
            title: "User 2's cake is ordered",
            category: .care,
            owner: .a,
            dueOn: date(2025, 8, 12),
            closesAt: nil,
    ...
    static let horizons: [FieldHorizon] = [
        FieldHorizon(
            ...
            openQuestion: FieldQuestion(
                ...
                reasoning: "Asking today because spring fares open in "
                    + "November, User 1's passport expires that March, and "
        ...
        FieldHorizon(
            id: "film",
            title: "User 1, shooting film again",
            window: nil,
            owner: .a,
            isPrimary: false,
            thesis: nil,
    ...
    static let evidence: [FieldEvidence] = [
        ...
        FieldEvidence(
            id: "passport-started",
            statement: "User 1's passport renewal started",
            owner: .a,
            horizonID: "japan",
    ...
    static let presenceBanner = (
        statement: "User 1's in the Hamptons until Sunday.",
    ...
    static let closedSeason = FieldSeason(
        ...
        oneThingThatDidntHappen: "User 1 didn't shoot film again. It's still on "
